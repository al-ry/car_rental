...
class DBManager {
  ...
  async getAdvertismentInfo(id) {
    let data = [id]
    let query = 'SELECT advertisment.id_user,user_name, user_phone, cost, description, transmission, is_open, photo_path, fuel, year, body, mark, model, city FROM advertisment ' +
